...
--
-- Base de datos: `sistema de datos de bancos`
--
...
INSERT INTO `cuenta bancaria` (`Id_Cuenta_Bancaria`, `Numero_Cuenta`, `Periodo_Validez`, `Id_Banco`, `Id_Cliente`) VALUES
(0, 0, '2020-12-02', 7, 5),
(1, 1, '2020-12-03', 8, 6),
(2, 2, '2020-12-07', 9, 7),
(3, 3, '2020-12-15', 10, 8),
...
CREATE TABLE `tarjeta de credito` (
...
INSERT INTO `tarjeta de credito` (`Id_TCredito`, `Numero_Seguridad`, `Clave_Acceso`, `Fecha_Caducidad`, `Id_Cliente`) VALUES
...
CREATE TABLE `tarjeta de debito` (
...
INSERT INTO `tarjeta de debito` (`Id_TDebito`, `Numero_Seguridad`, `Clave_Acceso`, `Fecha_Caducidad`, `Id_Cliente`) VALUES
...
ALTER TABLE `cuenta bancaria`
  ...
  ADD KEY `cuenta bancaria_ibfk_2` (`Id_Cliente`);

--
-- Indices de la tabla `tarjeta de credito`
--
ALTER TABLE `tarjeta de credito`
  ADD PRIMARY KEY (`Id_TCredito`),
  ADD KEY `tarjeta de credito_ibfk_1` (`Id_Cliente`);

--
-- Indices de la tabla `tarjeta de debito`
--
ALTER TABLE `tarjeta de debito`
...
--
ALTER TABLE `cuenta bancaria`
  ADD CONSTRAINT `cuenta bancaria_ibfk_1` FOREIGN KEY (`Id_Banco`) REFERENCES `banco` (`Id_Banco`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `cuenta bancaria_ibfk_2` FOREIGN KEY (`Id_Cliente`) REFERENCES `cliente` (`Id_Cliente`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `tarjeta de credito`
--
ALTER TABLE `tarjeta de credito`
  ADD CONSTRAINT `tarjeta de credito_ibfk_1` FOREIGN KEY (`Id_Cliente`) REFERENCES `cliente` (`Id_Cliente`);

--
-- Filtros para la tabla `tarjeta de debito`
--
ALTER TABLE `tarjeta de debito`
  ADD CONSTRAINT `tarjeta de debito_ibfk_1` FOREIGN KEY (`Id_Cliente`) REFERENCES `cliente` (`Id_Cliente`);
COMMIT;
